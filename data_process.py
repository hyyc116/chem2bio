...
def generate_edges(path):
    ...
    open('data/entity_id.json','w').write(json.dumps(entity_id).encode('utf-8',errors='ignore'))
    open('data/relation_id.json','w').write(json.dumps(relation_id).encode('utf-8',errors='ignore'))
